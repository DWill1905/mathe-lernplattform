...
export const zeige = (ziel) => {
    ...
    const schnellstart = el("section", { class: "schnellstart" }, el("a", { class: "knopf knopf-gross knopf-haupt", href: "#/uebung/mix" }, el("span", { class: "knopf-symbol", "aria-hidden": "true", text: "🎲" }), el("span", {}, el("span", { class: "knopf-titel", text: "Gemischtes Training" }), el("span", { class: "knopf-unter", text: "10 Aufgaben aus allen Themen" }))), el("a", { class: "knopf knopf-gross", href: "#/raetsel" }, el("span", { class: "knopf-symbol", "aria-hidden": "true", text: "🔤" }), el("span", {}, el("span", { class: "knopf-titel", text: "Rätselwort" }), el("span", { class: "knopf-unter", text: "Rechne und finde das geheime Wort" }))), el("a", { class: "knopf knopf-gross", href: "#/rechenmeister" }, el("span", { class: "knopf-symbol", "aria-hidden": "true", text: "⏱️" }), el("span", {}, el("span", { class: "knopf-titel", text: "Rechenmeister" }), el("span", {
        class: "knopf-unter",
