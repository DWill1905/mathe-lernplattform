...
export const zeige = (ziel) => {
    ...
    const abzeichen = el("section", { class: "karte" }, el("h2", { class: "abschnitt-titel", text: "Abzeichen" }), el("p", {
        class: "hinweis",
...
function kennzahl(titel, wert, unter) {
    return el("div", { class: "kennzahl" }, el("span", { class: "kennzahl-titel", text: titel }), el("span", { class: "kennzahl-wert", text: wert }), el("span", { class: "kennzahl-unter", text: unter }));
}
/** Balken für die letzten 14 Tage – zeigt, wie regelmäßig geübt wird. */
function aktivitaet(f) {
    const tage = [];
    for (let i = 13; i >= 0; i--) {
    ...
    return el("section", { class: "karte" }, el("h2", { class: "abschnitt-titel", text: "Die letzten zwei Wochen" }), saeulen, nochLeer
        ? el("div", { class: "leerzustand" }, el("div", { class: "eule-mittel" }, svgBild(euleSvg("schlaeft"), "")), el("p", {
            class: "hinweis",
