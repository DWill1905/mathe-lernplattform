...
const FORMEN = {
    ...
    gluehbirne: '<path d="M9.5 18.5h5M10.5 21.5h3"/><path d="M12 2.5a6.5 6.5 0 0 0-3.8 11.8v2.2h7.6v-2.2A6.5 6.5 0 0 0 12 2.5Z"/>',
    familie: '<circle cx="12" cy="6" r="3"/><path d="M7 21v-2.5A3.5 3.5 0 0 1 10.5 15h3a3.5 3.5 0 0 1 3.5 3.5V21"/>' +
        '<circle cx="4.5" cy="11" r="2"/><circle cx="19.5" cy="11" r="2"/><path d="M1.5 21v-1.5A2.5 2.5 0 0 1 4 17M22.5 21v-1.5A2.5 2.5 0 0 0 20 17"/>',
    mauer: '<rect x="2.5" y="5" width="19" height="14" rx="2"/><path d="M2.5 12h19M9 5v7M15 12v7"/>',
    geld: '<circle cx="12" cy="12" r="9"/><path d="M15.5 8.4A4.6 4.6 0 0 0 8.2 12a4.6 4.6 0 0 0 7.3 3.6"/><path d="M6.5 10.6h5.2M6.5 13.4h5.2"/>',
    mal: '<path d="M6.5 6.5l11 11M17.5 6.5l-11 11"/>',
    geteilt: '<path d="M4 12h16"/><circle cx="12" cy="6.6" r="1.5" fill="currentColor" stroke="none"/>' +
        '<circle cx="12" cy="17.4" r="1.5" fill="currentColor" stroke="none"/>',
    uhr: '<circle cx="12" cy="12" r="9"/><path d="M12 6.5V12l3.8 2.2"/>',
    lineal: '<rect x="2" y="8" width="20" height="8" rx="2"/><path d="M6.5 8v3.2M10.5 8v4.4M14.5 8v3.2M18.5 8v4.4"/>',
    formen: '<circle cx="7" cy="7.5" r="4.5"/><rect x="13" y="13" width="8" height="8" rx="1.5"/><path d="M17 2.5l4.2 7.5h-8.4z"/>',
    buch: '<path d="M4.5 19V5a2 2 0 0 1 2-2H19v18H6.5a2 2 0 0 1-2-2Z"/><path d="M6.5 17H19"/><path d="M9 7h6"/>',
    puzzle: '<path d="M4 4.5h4.6a2.7 2.7 0 0 1 5.4 0h5.5v4.6a2.7 2.7 0 0 0 0 5.4v5.5h-5.5a2.7 2.7 0 0 0-5.4 0H4v-5.5a2.7 2.7 0 0 0 0-5.4z"/>',
    /* ------------------------------------------------- Navigation und App */
    haus: '<path d="M3.5 10.5 12 3.5l8.5 7"/><path d="M5.5 9.5V20h13V9.5"/><path d="M10 20v-5.5h4V20"/>',
    diagramm: '<path d="M3.5 20.5V3.5"/><path d="M3.5 20.5h17"/><path d="M7 16.5V12M11.5 16.5V8M16 16.5v-6.5M20 16.5V6"/>',
    eltern: '<circle cx="8" cy="6.5" r="3"/><circle cx="17.5" cy="8" r="2.5"/>' +
        '<path d="M2.5 20.5v-2A3.5 3.5 0 0 1 6 15h4a3.5 3.5 0 0 1 3.5 3.5v2"/>' +
        '<path d="M16 20.5v-1.8a3 3 0 0 1 3-3h.5a2 2 0 0 1 2 2v2.8"/>',
    wuerfel: '<rect x="3" y="3" width="18" height="18" rx="4"/>' +
        '<circle cx="8.5" cy="8.5" r="1.4" fill="currentColor" stroke="none"/>' +
        '<circle cx="15.5" cy="15.5" r="1.4" fill="currentColor" stroke="none"/>' +
        '<circle cx="12" cy="12" r="1.4" fill="currentColor" stroke="none"/>',
    buchstaben: '<path d="M2.5 18.5 6 6l3.5 12.5M3.6 14.5h4.8"/><path d="M13 6h3.5a3 3 0 0 1 0 6H13zM13 12h4a3.2 3.2 0 0 1 0 6.5h-4z"/>',
    stoppuhr: '<circle cx="12" cy="13.5" r="7.5"/><path d="M12 9.5v4l2.5 1.8"/><path d="M9.5 2.5h5M12 2.5v3.5"/><path d="m18.5 6.5 1.8-1.8"/>',
    flamme: '<path d="M12 2.5s5.5 4.4 5.5 9.5a5.5 5.5 0 0 1-11 0c0-2 .9-3.6 1.8-4.8.4 1 1.1 1.8 2 2.2.5-2.7 1.7-5.2 1.7-6.9Z"/>',
    offline: '<path d="M2.2 8.6A15 15 0 0 1 7.6 5.4M16.4 5.4a15 15 0 0 1 5.4 3.2"/>' +
    ...
    /* ----------------------------------------------------------- Abzeichen */
    rakete: '<path d="M12 2.5c3.2 2.4 5 6 5 10.2l-1.8 3.3H8.8L7 12.7C7 8.5 8.8 4.9 12 2.5Z"/>' +
        '<circle cx="12" cy="10" r="2"/><path d="M8.8 16 6 18.5l1.2 3 2.4-1.4M15.2 16l2.8 2.5-1.2 3-2.4-1.4"/>',
    medaille: '<circle cx="12" cy="15" r="6"/><path d="m8.5 9.5-3-7M15.5 9.5l3-7M9 2.5h6"/>' +
    ...
    karte: '<path d="M2.5 6.5 9 4l6 2.5 6.5-2.5v13.5L15 20l-6-2.5L2.5 20z"/><path d="M9 4v13.5M15 6.5V20"/>',
    krone: '<path d="M3 8.5 6.5 13 12 4.5 17.5 13 21 8.5V19H3z"/><path d="M3 19h18"/>',
    funkeln: '<path d="M11 3.5 12.6 8l4.5 1.6-4.5 1.6L11 15.7 9.4 11.2 4.9 9.6 9.4 8z" fill="currentColor" stroke="none"/>' +
    ...
    /* ------------------------------------------------------------ Maskottchen */
    eule: '<path d="M12 21c-4.4 0-7.5-3.2-7.5-7.6V9.4C4.5 5.3 7.9 2.5 12 2.5s7.5 2.8 7.5 6.9v4C19.5 17.8 16.4 21 12 21Z" class="eule-koerper"/>' +
...
export function istIconName(wert) {
