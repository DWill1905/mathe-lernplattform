...
function koerper() {
    return (`<path d="M60 16C36 16 22 35 22 63v13c0 22 16 36 38 36s38-14 38-36V63c0-28-14-47-38-47z" class="bild-lila"/>` +
...
function fuesse() {
    return (`<ellipse cx="47" cy="110" rx="8" ry="5" class="bild-orange"/>` +
        `<ellipse cx="73" cy="110" rx="8" ry="5" class="bild-orange"/>`);
}
/** Ein offenes Auge: weißer Ring, Pupille, Glanzpunkt. */
function auge(x) {
    return (`<circle cx="${x}" cy="46" r="13" class="bild-hell"/>` +
...
function wangen() {
    return (`<circle cx="33" cy="58" r="4" class="bild-rosa"/>` +
 ...
 */
function fluegelHinten(haltung) {
    if (haltung === "unten") {
        return (`<ellipse cx="20" cy="78" rx="9" ry="19" class="bild-lila-hell" transform="rotate(18 20 78)"/>` +
            `<ellipse cx="100" cy="78" rx="9" ry="19" class="bild-lila-hell" transform="rotate(-18 100 78)"/>`);
    }
    return (`<ellipse cx="13" cy="44" rx="8" ry="19" class="bild-lila-hell" transform="rotate(42 13 44)"/>` +
...
const POSEN = {
    ...
    mutmacht: () => `<ellipse cx="20" cy="78" rx="9" ry="19" class="bild-lila-hell" transform="rotate(18 20 78)"/>` +
        koerper() +
        fuesse() +
        gesicht("froh") +
        zeigFluegel() +
 ...
 */
export function euleJubelGruppe() {
    return POSEN.jubelt();
}
/**
 ...
 */
export function euleFuerQuote(richtig, gesamt) {
    if (gesamt === 0)
        return "winkt";
